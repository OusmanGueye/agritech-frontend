...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../formation.test-samples';

import { FormationService, RestFormation } from './formation.service';

const requireRestSample: RestFormation = {
