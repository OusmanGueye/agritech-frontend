...
export class SiteService {
  ...
  createSite(site: any): Observable<EntityResponseType> {
    return this.http.post<ISite>(`${this.resourceUrl}/create`, site, { observe: 'response' });
  }

  getAllSites(): Observable<EntityArrayResponseType> {
    return this.http.get<ISite[]>(`${this.resourceUrl}/get-all`, { observe: 'response' });
  }
